...
# defaults
SERVER = 'nhmp.eu.nicehash.com'
USER = '38tQRRn1BVGe5v8dshLzjeMric3wZaEWQA.benchmark'

ports = {
    'blake2s':          3200,
    'cryptonight':      3200,
    'daggerhashimoto':  3200,
    'decred':           3200,
    'equihash':         3200,
    'lbry':             3200,
    'lyra2rev2':        3200,
...
algos = [
  #  'benchmark-blake2s',
    'benchmark-cryptonightV7',
    'benchmark-daggerhashimoto',
  #  'benchmark-decred',
  #  'benchmark-equihash',
  #  'benchmark-lbry',
    'benchmark-lyra2rev2',
 #   'benchmark-neoscrypt',
  ...
  #  'benchmark-keccak',
  #  'benchmark-sia',
   # 'benchmark-daggerhashimoto_decred',
   # 'benchmark-daggerhashimoto_pascal',
   # 'benchmark-daggerhashimoto_sia',
    'benchmark-x16r',
	'benchmark-lyra2z'  
   ]
